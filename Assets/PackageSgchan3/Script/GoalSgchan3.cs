...
public class GoalSgchan3 : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            GameMasterSgchan3.clear = true;
            maincamera = GameObject.FindGameObjectWithTag("MainCamera").GetComponent<Camera>();
            maincamera.GetComponent<CameraScriptSgchan3>().enabled = false;
            Invoke("Goaling", 4);
        }
    ...
    void Last()
    {
        ...
        player.GetComponent<ControllerSgchan3>().fallline = -4000;
